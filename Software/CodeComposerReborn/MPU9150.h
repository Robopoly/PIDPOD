...
int MPU9150_readSensor_2byte(unsigned char, unsigned char); // no more C++ :/
int MPU9150_readSensor(unsigned char);
int MPU9150_writeSensor(unsigned char, unsigned char);
